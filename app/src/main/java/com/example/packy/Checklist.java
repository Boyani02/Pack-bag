...
import com.example.packy.Adapter.CheckListAdapter;
        ...
        switch (item.getItemId()){
            ...
            case R.id.btnReset:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure?\n\nAs this will load the default provided by (Pack Your Bag)" +
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(itemName !=null && !itemName.isEmpty()){
                    ...
                    Toast.makeText(Checklist.this, "Item can't be added", Toast.LENGTH_SHORT).show();
                }
            }
        });
